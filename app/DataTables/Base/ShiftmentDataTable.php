...
class ShiftmentDataTable extends DataTable
{
    /**
    ...
    */
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'base.shiftments.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Shiftment $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Shiftment $model)
    {
    ...
    {
        return 'shiftments_datatable_' . time();
    }
}
